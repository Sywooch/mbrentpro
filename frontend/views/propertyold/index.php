                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="col-md-10 col-sm-10 padding0 ">
                        <div class="input-group full-width">
                            ...
                            <input type="text" class="form-control full-width  paddingtb20 " placeholder="Username">
                        </div>
                    </div>

                    <div class="col-md-2 col-sm-2 padding0">
                        <div class="btn-group zindex full-width ">
                            <button type="button" class="btn btn-block yellow  padding10 "><span class="glyphicon glyphicon-search"></span></button>
...
<?= ListView::widget([
        ...
        'itemOptions' => ['class' => 'col-md-4 col-sm-2 col-xs-12'],
