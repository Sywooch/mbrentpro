...
class PropertiesSearch extends Properties
{
    ...
    {
        return [
            [['id', 'propertyid', 'yearbuilt', 'numberunits', 'waitlist', 'nofee', 'isopentolease', 'rentisbasedonincome', 'bedrooms', 'fullbaths', 'halfbaths', 'ismobilityaccessible', 'isvisionaccessible', 'ishearingaccessible', 'unitid', 'isexists'], 'integer'],
            [['description', 'address', 'city', 'state', 'zip', 'zip4', 'unittype', 'unitname', 'unitdescription'], 'safe'],
